<script lang="ts">
	import { EllipsisVertical, Download, Upload, Trash } from 'lucide-svelte';

	export let saveConfigurationToFile: () => void;
	export let loadConfigurationFromFile: () => void;
	export let configurationReset: () => void;
</script>
